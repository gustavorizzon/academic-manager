...
<div class="card card-secondary">
  <div class="card-header">
    <h3 class="card-title">{{ __('Editing graduation') . ': ' . $graduation->institution_member->nome . ' -> ' . $graduation->titulo }}</h3>
  </div>
  {!! Form::open(['route' => ['registration.graduations.update', $graduation->id], 'method' => 'put']) !!}
    ...
    <div class="row">
      <div class="col-sm">
        <div class="form-group">
          ...
          {!! Form::text('titulo', $graduation->titulo, [
      ...
      <div class="col-sm-3">
        <div class="form-group">
          ...
          {!! Form::text('numero_titulo', $graduation->numero_titulo, [
      ...
      <div class="col-sm">
        <div class="form-group">
          ...
          {!! Form::select('membro_instituicao_id',
            \App\Models\MembroInstituicao::orderBy('nome')->pluck('nome', 'id')->toArray(),
            $graduation->membro_instituicao_id,
