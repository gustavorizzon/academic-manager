...
<div class="card card-secondary">
  <div class="card-header">
    <h3 class="card-title">{{ __('Courses Registration') }}</h3>
  </div>

  {!! Form::open(['route' => 'registration.courses.store']) !!}
    ...
    <div class="row">
      ...
      <div class="col-sm">
        <div class="form-group">
          ...
          {!! Form::number('quantidade_semestres', null, [
