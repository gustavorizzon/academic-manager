...
<div class="card card-secondary">
  <div class="card-header">
    <h3 class="card-title">{{ __('Adding disciplines to the course') . ': ' . \App\Models\Curso::find($course_id)->nome }}</h3>
  </div>

  {!! Form::open(['route' => ["registration.courses.disciplines.store", ['id' => $course_id]]]) !!}

  {!! Form::hidden('curso_id', $course_id) !!}
      ...
      <div class="col">
        <div class="form-group">
          ...
          {!! Form::select('disciplina_id',
            \App\Models\Disciplina::orderBy('nome')->pluck('nome', 'id')->toArray(), null,
  ...
  <div class="card-footer">
    {!! Form::button(
      '<i class="far fa-save fa-fw"></i> ' . __('Add!'),
      [
        'type' => 'submit',
        'class' => 'btn btn-primary'
      ]
    ) !!}
    <a href="{{ route('registration.courses.disciplines.index', ['id' => $course_id]) }}" class="btn btn-outline-danger float-right">
