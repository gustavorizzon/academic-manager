...
<div class="card card-secondary">
  <div class="card-header">
    <h3 class="card-title">{{ __('Enrolling a student') }}</h3>
  </div>

  {!! Form::open(['route' => 'coordinator.enrollments.store']) !!}
      ...
      <div class="col-sm">
        <div class="form-group">
          ...
          {!! Form::select('membro_instituicao_id',
            \App\Models\MembroInstituicao::where('tipo_membro', \App\Models\MembroInstituicao::STUDENT)->pluck('nome', 'id')->toArray(), null,
      ...
      <div class="col-sm">
        <div class="form-group">
          ...
          {!! Form::select('curso_id',
            \App\Models\Curso::orderBy('nome')->pluck('nome', 'id')->toArray(), null,
